...
const initial = {
  ...
  sales_quote_designs: [{ id: "norman-grid-design", line_item_id: "norman-grid-line", variant: "A", supplier: "Norman", product_type: "Roller Shades", material: "Soluna Roller Shades", unit_price: 0, mount_type:"Inside Mount", shade_type:"Single", lift_system:"Cordless",valance:"No Valance",fabric:"Amelia", options_json: { valance:"No Valance", fabric_color_code:"F1484",fabric_collection:"Amelia",roller_application:"Single",roller_top_treatment:"No Top Treatment",roller_tube:"All Tubes",roller_region_scope:"ca_ma",catalog_product_id: "roller", catalog_program_id: "roller_cordless_fabric_price_group_2_pg2", catalog_manufacturer: "Norman", catalog_product_type: "Roller Shades", quote_lab_product_id: "roller", quote_lab_program_id: "roller_cordless_fabric_price_group_2_pg2", base_price: 0, surcharge_total: 0, pricing_method: "none", pricing_block_reason: "invalid_dimensions", pricing_calculation_status: "invalid", pricing_input_width_whole: 0, pricing_input_width_fraction: "0", pricing_input_height_whole: 0, pricing_input_height_fraction: "0" } }],
};
