...
1. Place the received originals in `public/images/portfolio-inbox/`.
...
Do not add new portfolio photos to the homepage or product story rail unless that is specifically requested. The portfolio gallery is the default destination.
