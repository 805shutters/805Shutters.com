...
This resolves the blanket AMX restriction status only for new typed configurations; old snapshots and prices remain unchanged. Outside/side mounting, unsupported motors/valances, impossible donor cuts and unavailable cells remain blocked. The September 20 CAMX2772W cart comparison remains representative current-price evidence. It does not establish the controlling effective date for the entire price book, final freight or applicability of checkout/order-level dealer charges. Existing 805 selling-price policy is preserved. Live verification of the new typed route is pending deployment.
