...
SmartFold style increment reconciles all 15 fabric coordination defaults, six reversible Impressions patterns, component colors, all twelve Modern Wood valance finishes, four premium hem finishes and their fixed end caps, fabric-valance overrides and chain/tension-device coordination from guide pages 5–8, 15, 19 and 21. These selections are validated server-side and retained in the derived assembly. Local CRM selection/save/reopen passed for F1794 Ice White, Reverse, silver curved fascia and Bronze premium hem. Backend retail is $935 including the selected hardware/accessories. Release and production proof of this style increment remain pending. Shared valances, custom valance geometry and remaining mounting rules are still incomplete.
