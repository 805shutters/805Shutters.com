...
exceptions.update({
 'norman_roller_valance_only':'Source-backed natural valance destination with exact styles, finishes, fabric IDs, returns and joinery. Implementation integrated; production proof pending. Current standalone price, availability and freight unresolved.',
 'norman_roller_separate_valance':'Separate valance preserves selected shade identities and mixed-lift associations with exact compatibility rules. Implementation integrated; production proof pending. Largest hardware/material-width mapping, shared price allocation, availability and freight unresolved.',
