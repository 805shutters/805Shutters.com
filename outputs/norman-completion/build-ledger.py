...
exceptions.update({
 'norman_roller_valance_only':'Source-backed natural valance destination with exact styles, finishes, fabric IDs, returns and joinery. Production 0361 full-reload persistence and exact 18-inch joinery error proof complete. Current standalone price, availability and freight unresolved.',
 'norman_roller_separate_valance':'Separate valance preserves selected shade identities and mixed-lift associations with exact compatibility rules. Production 0361 full-reload persistence, shade associations and source fabric-width mapping verified. Largest hardware threshold, shared price allocation, availability and freight unresolved.',
 'norman_ultimate_faux_valance_only':'Standalone Ultimate valance destination uses original finish IDs and typed inner length, returns and connector/keystone records. Source boundary rules and0355 full-reload production proof complete. Standalone price, availability and freight unresolved.',
 'norman_smartprivacy_valance_only':'Standalone SmartPrivacy valance destination uses original finish IDs and typed inner length, returns and equal connector splits. Source boundary rules and0355 full-reload production proof complete. Standalone price, availability and freight unresolved.',
