...
import { Card, CardContent, CardHeader, CardTitle } from "@mts-v1/components/ui/card";
...
import { Switch } from "@mts-v1/components/ui/switch";
import {
  Dialog,
  DialogContent,
  DialogFooter,
  DialogHeader,
  DialogTitle,
} from "@mts-v1/components/ui/dialog";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
} from "@mts-v1/components/ui/accordion";
import { SignaturePad } from "@mts-v1/components/crm/SignaturePad";
import {
  FileText,
  CreditCard,
  Zap,
...
import { formatDimensionsOrNull } from "@mts-v1/types/quote";
import { formatCurrency, getQuoteDesignDetails } from "@mts-v1/lib/quoteDesignDetails";
import {
  ...
  type QuoteExtraFee,
} from "@mts-v1/lib/quoteTotals";
import { getAccountName, ACCOUNT_IDS } from "@mts-v1/lib/accounts";
import { PAYMENT_METHODS, getQuoteColor } from "@mts-v1/lib/quoteConstants";
import { getLineItemProductImage } from "@mts-v1/lib/quoteProductImages";
import { QuoteGroupTabs } from "./QuoteGroupTabs";
import { SendQuoteDialog } from "./SendQuoteDialog";
import type { SalesQuote, SalesQuoteLineItem, SalesQuoteDesign } from "@mts-v1/types/quote";
