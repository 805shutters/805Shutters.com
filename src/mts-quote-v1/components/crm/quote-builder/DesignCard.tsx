...
import { Card, CardContent, CardHeader } from "@mts-v1/components/ui/card";
import { Button } from "@mts-v1/components/ui/button";
import { Input } from "@mts-v1/components/ui/input";
import { Label } from "@mts-v1/components/ui/label";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@mts-v1/components/ui/select";
import { Tabs, TabsList, TabsTrigger } from "@mts-v1/components/ui/tabs";
import { Checkbox } from "@mts-v1/components/ui/checkbox";
import {
  AlertTriangle,
  ArrowLeftRight,
  Archive,
...
import { formatDimensions } from "@mts-v1/types/quote";
import {
...
} from "@mts-v1/lib/normanRollerFabricCatalog";
import {
...
import type { SpecialtyShape } from "@mts-v1/lib/quoteConstants";
import type { SalesQuoteLineItem, SalesQuoteDesign } from "@mts-v1/types/quote";
import {
  getRollerV2UiFacets,
...
import { getCatalogPricingProvenance } from "@/lib/quote/catalog";
import {
  measurementToInches,
...
import {
  ...
  type ShutterProgram,
  type Surcharge,
} from "@mts-v1/lib/pricingData";
import { useRetailPriceStore } from "@mts-v1/stores/retailPriceStore";
import { useQuoteBuilderDatabase } from "@mts-v1/integrations/supabase/quoteBuilderDatabase";
import { calculateLineItemDesignTotal } from "@mts-v1/lib/quoteTotals";
import {
...
export function DesignCard({
  ...
  const handleRecalculateLockedPrice = () => {
    ...
    let priceBreakdown = getProductPriceBreakdown({
      ...
      componentWidthsInches: [2, 3].includes(Number(opts.lotus_blind_count)) ? Array.from({ length: Number(opts.lotus_blind_count) }, (_, index) => index + 1).map(index => Number(opts[`lotus_blind_${index}_width_inches`])) : undefined,
