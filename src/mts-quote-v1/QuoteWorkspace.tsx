...
import { PortalContainerContext } from "@mts-v1/lib/portal-container";
...
const QuoteDashboard = lazy(() =>
  import("@mts-v1/components/crm/quote-builder/QuoteDashboard").then((module) => ({
    default: module.QuoteDashboard,
  }))
);
const QuoteBuilder = lazy(() =>
  import("@mts-v1/components/crm/quote-builder/QuoteBuilder").then((module) => ({
    default: module.QuoteBuilder,
  }))
);
const QuoteContract = lazy(() =>
  import("@mts-v1/components/crm/quote-builder/QuoteContract").then((module) => ({
    default: module.QuoteContract,
  }))
);
const PricingGrids = lazy(() =>
  import("@mts-v1/components/crm/quote-builder/PricingGrids").then((module) => ({
