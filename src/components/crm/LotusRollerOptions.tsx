...
export function LotusRollerOptions({design,programId,onUpdateFields}:{design:SalesQuoteDesign|undefined;programId:string;onUpdateFields:(fields:Partial<SalesQuoteDesign>)=>void}) {
