...
export function lotusProgramSelectionPatch(
  ...
  return {
    ...
    mount_type: null, fabric: null, shade_type: null, lift_system: vertical ? vertical.rail ? "Wand control" : "None" : program.id === LOTUS_AMX_PROGRAM ? "Cordless" : lotusRollerOpacity(program.id) ? "Cordless Spring Roller" : null,
    motor_type: null, remote_type: null, valance: vertical ? vertical.valance : program.id === LOTUS_AMX_PROGRAM ? "None" : lotusRollerOpacity(program.id) ? "Smooth valance" : null,
    options_json: {
