  ...
  return (
    <QueryClientProvider client={queryClient}>
      <PortalContainerContext.Provider value={scopeEl}>
        <div
          ref={setScopeEl}
          className="mts-quote-scope min-h-full bg-[#eef3f8] light"
          data-theme="light"
        >
          {/* Tab buttons */}
          <div className="sticky top-0 z-40 border-b border-[#d0d8e0] bg-white/95 px-4 py-2 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/85 sm:px-5">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "bg-white border-[#0077b6]/30 text-[#1a1f36] hover:border-[#0077b6] hover:shadow-sm"
                    )}
                  >
