...
export function CustomModePanel({ lineItem, design }: { lineItem: SalesQuoteLineItem; design: SalesQuoteDesign }) {
  ...
  const [v, setV] = useState({ freightCost:"0",otherCost:"0",profitMode:"dollar",profitValue:"125",finalSellPrice:"",roomName:lineItem.room_name||"",designName:design.variant||"",widthWhole:String(lineItem.width_whole||0),widthFraction:lineItem.width_fraction||"0",heightWhole:String(lineItem.height_whole||0),heightFraction:lineItem.height_fraction||"0" });
