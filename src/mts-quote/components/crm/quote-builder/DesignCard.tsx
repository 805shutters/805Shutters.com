  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        {authoritativeV2 && manufacturerOptionsRoute.productId === "roller" && <><NormanRollerHardwareOptions design={currentDesign} onUpdateFields={updateFields} /><NormanRollerAccessoriesOptions design={currentDesign} onUpdateFields={updateFields} /><NormanRollerChainOptions design={currentDesign} onUpdateFields={updateFields} /><NormanRollerPoleOptions design={currentDesign} onUpdateFields={updateFields} /></>}
