      ...
      {pipelineQuotes.length === 0 ? (
        ...
        <div className="divide-y divide-slate-100">
          {pipelineQuotes.map((quote) => {
            ...
            const polarHold = "line_items" in quote
              ? getPolarQuoteOnlyHold(quote as SalesQuoteWithItems)
              : { blocked: false, lineItems: [], message: null };
              ...
              <div key={quote.id} className="grid gap-4 p-4 xl:grid-cols-[minmax(0,1.4fr)_minmax(280px,1fr)_auto]">
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {polarHold.blocked && (
                      <span className="rounded-full border border-blue-300 bg-blue-50 px-2.5 py-0.5 text-xs font-bold text-blue-900">
                        QUOTE ONLY · Polar automation blocked
                      </span>
                    )}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto]">
                    ...
                    {quote.status === "sold" && (
                      <Button
                        ...
                        disabled={isUpdating || polarHold.blocked}
                  ...
                  {polarHold.message && <p className="text-xs font-semibold text-blue-900">{polarHold.message}</p>}
                </div>
