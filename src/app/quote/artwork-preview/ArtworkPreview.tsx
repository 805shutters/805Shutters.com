...
export function ArtworkPreview() {
  ...
  const options = [...productOptions, ...(temporary ? ["Complementary temporary paper shade: Free"] : []), `Manufacturer: ${manufacturer}`, ...(selectedValance ? [`Valance: ${selectedValance.aliases[0]}`] : [])];
