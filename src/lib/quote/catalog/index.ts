import { rollerValanceProducts } from "../norman-roller-valance-only";
import { valanceOnlyProducts } from "../norman-valance-only";
...
export const catalog: Catalog = {
  ...
  } : product).map(withFall2026RollerPrograms), ...shutterCatalog.products, ...romanAncillaryProducts, ...valanceOnlyProducts, ...rollerValanceProducts, smartdrapeReplacementProduct, ...onyxHeldProducts, ...sanClementeProducts, ...normanContractProducts, ...polarCatalog.products, ...lotusCatalog.products, ...lotusObservedProducts, ...sundanceCatalog.products],
