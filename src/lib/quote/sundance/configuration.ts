...
export function hasSundanceConfiguration(productId: string | null | undefined): boolean {
  return productId === "sundance_cellular" || productId === SUNDANCE_DRAPERY_TRACK_ID
    || ["sundance_portfolio_roman","sundance_sheerview",...sundanceShadeProductIds,...sundanceHorizontalProductIds,"sundance_vertical_essence", "sundance_walden_premier", "sundance_walden_select"].includes(productId ?? "");
}
