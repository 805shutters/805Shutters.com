...
export type RollerCommonChoice={version:1;groupId:string;position:number;gapAfter:number;returns:typeof ROLLER_RETURN_SIDES[number];customWidth:number|null;fabricCode?:string};
export const emptyRollerCommon=():RollerCommonChoice=>({version:1,groupId:"",position:1,gapAfter:0,returns:"None",customWidth:null,fabricCode:""});
