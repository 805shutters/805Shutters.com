import {parseNormanSpecialtyHinge,type NormanSpecialtyHingeRecord} from './norman-shutter-specialty-hinge';
import {parseNormanSpecialtyCurvedTilt,type NormanSpecialtyCurvedTilt} from './norman-shutter-specialty-tilt';
...
export type NormanSpecialtyRecord = {
 ...
 hingeGeometry?:NormanSpecialtyHingeRecord; sunburstHubInches:number|null; stileWidthInches:number|null; geometry?:NormanSpecialtyGeometryRecord; frameConstruction?:NormanSpecialtyFrameConstruction; curvedTilt?:NormanSpecialtyCurvedTilt;
};
...
export function parseNormanSpecialtyRecord(value:unknown):NormanSpecialtyRecord|null{
 ...
 if(r.hingeGeometry!==undefined&&!parseNormanSpecialtyHinge(r.hingeGeometry))return null;
 if(r.curvedTilt!==undefined&&!parseNormanSpecialtyCurvedTilt(r.curvedTilt))return null;
