...
export type NormanSpecialtyRecord = {
 ...
 sunburstHubInches:number|null; stileWidthInches:number|null; geometry?:NormanSpecialtyGeometryRecord; frameConstruction?:NormanSpecialtyFrameConstruction; curvedTilt?:NormanSpecialtyCurvedTilt;
};
