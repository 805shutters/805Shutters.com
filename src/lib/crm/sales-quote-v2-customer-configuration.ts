...
export const V2_CUSTOMER_CONFIGURATION_FIELDS = [
  ...
  ["perfectsheer_keystone_layout", "Splice Locations"],
  ["perfectsheer_splice_span_offset", "First Shade Offset from Valance Left"],
  ["perfectsheer_keystone_location_1", "Joint 1 from Valance Left"],
  ["perfectsheer_keystone_location_2", "Joint 2 from Valance Left"],
  ["perfectsheer_keystone_location_3", "Joint 3 from Valance Left"],
  ["perfectsheer_keystone_location_4", "Joint 4 from Valance Left"],
  ["perfectsheer_keystone_location_5", "Joint 5 from Valance Left"],
  ...
  ["smartfold_keystone_layout", "Splice Locations"],
  ["smartfold_splice_span_offset", "First Shade Offset from Valance Left"],
  ["smartfold_keystone_location_1", "Joint 1 from Valance Left"],
  ["smartfold_keystone_location_2", "Joint 2 from Valance Left"],
  ["smartfold_keystone_location_3", "Joint 3 from Valance Left"],
