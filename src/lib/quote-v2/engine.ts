...
export function authoritativeAutomaticSurchargeSelections(
  ...
  if (selection.productId === "roman" && /norman-roman-mounting-2026-09-20-r[45678]$/.test(selection.catalogVersion)) {
  ...
  if (selection.productId === "roman" && /norman-roman-mounting-2026-09-20-r[5678]$/.test(selection.catalogVersion) && details.valance === "fabric_valance") {
