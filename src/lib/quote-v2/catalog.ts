...
export function quoteV2CatalogVersionFor(
  ...
  if (productId === "smartfold" && asOf >= "2026-09-20") return `${QUOTE_V2_CATALOG_VERSION}-norman-smartfold-accessories-2026-09-20-r12`;
  ...
  if (productId === "roller" && asOf >= "2026-09-20") return `${QUOTE_V2_ROLLER_PREVIEW_VERSION}-group-hardware-2026-09-20-r7`;
