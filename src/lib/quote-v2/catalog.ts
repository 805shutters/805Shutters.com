...
export function quoteV2CatalogVersionFor(
  ...
  if (productId === "smartfold" && asOf >= "2026-09-20") return `${QUOTE_V2_CATALOG_VERSION}-norman-smartfold-standard-valances-2026-09-20-r13`;
  ...
  if (productId === "roller" && asOf >= "2026-09-20") return `${QUOTE_V2_ROLLER_PREVIEW_VERSION}-poles-2026-09-20-r10`;
