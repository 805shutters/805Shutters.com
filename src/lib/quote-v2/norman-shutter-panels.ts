...
export function validateNormanShutterPanels(s:SelectionContext):ValidationIssue[]{
  ...
  issues.push(...validateNormanBifold90(s,record),...validateNormanDoubleHung(s,record),...validateNormanRegularWidths(s,record),...validateNormanSingleLouver(s,record),...validateNormanShutterSpecialty(s,record),...validateNormanShutterBypass(s,record),...validateNormanShutterBifold180(s,record),...validateNormanShutterBottomSupport(s,record),...validateNormanShutterDividers(s,record));
  return issues;
}
