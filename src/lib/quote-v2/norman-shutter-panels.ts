import {validateNormanBifold90} from './norman-shutter-bifold90';
...
export function validateNormanShutterPanels(s:SelectionContext):ValidationIssue[]{
  ...
  issues.push(...validateNormanFrenchDoor(s,record),...validateNormanBifold90(s,record),...validateNormanDoubleHung(s,record),...validateNormanRegularWidths(s,record),...validateNormanSingleLouver(s,record),...validateNormanShutterSpecialty(s,record),...validateNormanShutterBypass(s,record),...validateNormanShutterBifold180(s,record),...validateNormanShutterBottomSupport(s,record),...validateNormanShutterDividers(s,record));
  return issues;
}
