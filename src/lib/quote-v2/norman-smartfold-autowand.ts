...
export function smartfoldAutoWand(s:SelectionContext){
 if(s.productId!=="smartfold"||s.catalogAsOf<"2026-09-20"||!["-norman-smartfold-autowand-2026-09-20-r14","-norman-smartfold-inside-fascia-2026-09-20-r15","-norman-smartfold-inside-light-guard-2026-09-20-r16"].some(v=>s.catalogVersion.endsWith(v))||String(s.configuration.lift_system).toLowerCase()!=="motorized"||String(s.configuration.motor_type).toLowerCase()!=="autowand")return null;
