...
},
{
...

  {
    ...
    receivedDate: "2026-09-19", modifiedDate: null, pageCount: 13,
    sha256: "39fdc0fe46188ef773edd9ff8833312664a895e3ff799c3b26643cda6840f7e1",
    authorities: ["assortment", "restrictions", "options"],
    sourceUrl: "https://download.normanwindowcoverings.com/Document/Service/download/ProgramBinderSync/Other/Norman/San%20Clemente/San%20Clemente%20Guide.pdf",
  },
  {
...
},
{
...
},
  {
    ...
    kind: "dealer_portal_snapshot",
    format: "json",
    fileName: "onyx-portal-20260920.json",
    title: "Onyx CHE01 current shutter assortment and six price fixtures",
    revision: "Authenticated visible controls and unsubmitted comparison drafts observed 2026-09-20",
    effectiveDate: null,
    effectiveDateEvidence: "Portal observation date only; no manufacturer effective date published",
    receivedDate: "2026-09-20",
    modifiedDate: "2026-09-20",
    sha256: "bd516b17f81b41c5f9c7b8d3ffd1ee83abbfde44e510630d78c644487ca27eb9",
    authorities: ["assortment", "options", "pricing"],
    sourceUrl: "https://admin.onyxshutters.com/OrderDetail.aspx",
    accountScope: "CHE01 California Home Exterior; observations do not establish every construction limit or selling rate",
  },
  {
  ...
  {
    id: "norman-shutter-frame-pricing-2026-05",
    manufacturer: "Norman",
    kind: "product_guide",
    format: "pdf",
    fileName: "m. Pricing--3c7eefdef7.pdf",
    title: "Woodlore Shutters Pricing - Window Size Frame Additions",
    revision: "Current 2026 Program Binder copy; source file created 2025-12-18",
    effectiveDate: null,
    effectiveDateEvidence:
      "The authenticated 2026 Program Binder exposes this revision but the PDF does not print a separate effective date",
    receivedDate: "2026-07-27",
    modifiedDate: "2025-12-18",
    sha256: "4e8ea2a3ff8fe52b85b3bfd033cbba6ae4076b3c4302406f2d3f98d7d2ecc7d2",
    authorities: ["pricing", "restrictions", "options"],
    pageCount: 3,
    sourceUrl: "Authenticated Norman Program Binder",
  },
  {
  ...
  },
  {
    ...
    title: "Product Pricing (other dealer account - quarantined)",
    ...
    quarantineReason:
      "The PDF belongs to a different dealer account. Its $8 additional-unit freight rate must never drive current 805 pricing.",
    pageCount: 3,
  },
  {
