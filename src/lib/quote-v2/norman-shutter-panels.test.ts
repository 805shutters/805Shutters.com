...
const record=(height=60):NormanShutterPanelRecord=>({version:1,application:'regular',motor:'none',existingDoorGlassOrSidelight:false,panels:[{heightInches:height,widthInches:24,divider:'none',wholePanelLouverCount:6,bottomSupport:{version:1,support:'existing_sill',gapInches:0.0625,frequentlyOpen:false}}]});
const context=(programId='woodlore',r:unknown=record()):SelectionContext=>({manufacturerId:'Norman',productId:'norman_shutters',programId,catalogAsOf:'2026-09-20',catalogVersion:'current',widthInches:36,heightInches:60,quantity:1,configuration:{panel_config:'L',widest_panel_width_inches:24,[NORMAN_SHUTTER_PANEL_RECORD]:r as SelectionContext['configuration'][string]},options:{}});
