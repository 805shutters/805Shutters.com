...
const shade=(position:number,width=36,configuration:SelectionRecord={}):SelectionContext=>({manufacturerId:"Norman",productId:"roller",programId:"roller_cordless_fabric_price_group_1_pg1",catalogAsOf:"2026-09-20",catalogVersion:quoteV2CatalogVersionFor("roller","2026-09-20"),widthInches:width,heightInches:60,quantity:2,options:{},configuration:{roller_application:"Common Valance",lift_system:"Cordless",mount_type:"Inside Mount",valance:"Square Fascia*",roller_top_treatment:"Square Fascia",roller_tube:'2" (52mm) Tube',fabric_color_code:"F1484",[KEY]:{...emptyRollerCommon(),groupId:"Room A",position},...configuration}});
