...
export function romanHardware(s:SelectionContext){
 ...
 const mountingRevision = /norman-roman-mounting-2026-09-20-r[23456789]$/.test(s.catalogVersion);
 ...
 const bandingRevision = /norman-roman-mounting-2026-09-20-r[3456789]$/.test(s.catalogVersion);
 ...
 const finishingRevision = /norman-roman-mounting-2026-09-20-r[6789]$/.test(s.catalogVersion);
