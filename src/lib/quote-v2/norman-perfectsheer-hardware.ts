...
export function perfectsheerHardware(context: SelectionContext) {
  ...
  return {
    ...
    record:{
      ...
      magneticHoldDown:magnetic?{bracketCount:2,catchColor:c.perfectsheer_magnet_color||"Nickel-Plated",extraSideClearance:.5625,extraBottomClearance:.6875,magnetFactoryInstalled:true,measuredClearance:magneticClearanceRecord(context)}:null,
