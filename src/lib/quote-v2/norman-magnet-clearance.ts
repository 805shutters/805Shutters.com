...
const current=(s:SelectionContext)=>s.catalogAsOf>='2026-09-20'&&((s.productId==='smartfold'&&['-norman-smartfold-mounting-2026-09-20-r10','-norman-smartfold-manual-2026-09-20-r11'].some(v=>s.catalogVersion.endsWith(v)))||(s.productId==='perfectsheer'&&s.catalogVersion.endsWith('-norman-perfectsheer-magnet-2026-09-20-r8')));
