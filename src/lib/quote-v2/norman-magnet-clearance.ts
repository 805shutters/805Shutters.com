...
const current=(s:SelectionContext)=>s.catalogAsOf>='2026-09-20'&&((s.productId==='smartfold'&&['-norman-smartfold-mounting-2026-09-20-r10','-norman-smartfold-manual-2026-09-20-r11','-norman-smartfold-accessories-2026-09-20-r12','-norman-smartfold-standard-valances-2026-09-20-r13','-norman-smartfold-autowand-2026-09-20-r14','-norman-smartfold-inside-fascia-2026-09-20-r15','-norman-smartfold-inside-light-guard-2026-09-20-r16'].some(v=>s.catalogVersion.endsWith(v)))||(s.productId==='perfectsheer'&&['-norman-perfectsheer-magnet-2026-09-20-r8','-norman-perfectsheer-networks-2026-09-20-r9','-norman-perfectsheer-hubs-2026-09-20-r10'].some(v=>s.catalogVersion.endsWith(v))));
