...
export function deriveRollerCommonValances(lines:readonly {lineId:string;selection:SelectionContext}[]):ValidationIssue[]{
 ...
 for(const [groupId,members] of groups){
  ...
  const exactWidths=/-material-2026-09-20-r6$|-group-hardware-2026-09-20-r7$|-accessories-2026-09-20-r8$|-chain-2026-09-20-r9$|-poles-2026-09-20-r10$|-light-guard-2026-09-20-r11$/.test(s.catalogVersion);
  ...
  const hardware=/-group-hardware-2026-09-20-r7$|-accessories-2026-09-20-r8$|-chain-2026-09-20-r9$|-poles-2026-09-20-r10$|-light-guard-2026-09-20-r11$/.test(s.catalogVersion)?deriveRollerGroupHardware(sorted,"common"):null;
