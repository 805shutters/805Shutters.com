...
export const answerPages: AnswerPage[] = [
  ...
  },
  {
    ...
    relatedLinks: [
      { label: "Custom blinds", href: "/blinds/" },
      { label: "Blinds in Moorpark", href: "https://www.805shutters.com/blinds/" },
      { label: "Blinds in Thousand Oaks", href: "https://www.805shutters.com/blinds/" },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { label: "Custom drapery and curtains", href: "https://www.805shutters.com/drapery/" },
      { label: "Customer reviews", href: "/reviews/" },
      { label: "Free consultation", href: "/free-window-treatment-consultation/" },
      { label: "Book a consultation time", href: "/book-consultation/" }
    ]
